...
public class housewith2rooms extends House {
    ...
    public housewith2rooms(String HouseNo, String RenterId, String propertyId, String Location, double Baserent, int Duration, String hasgarden, String haspets, double TotalFee) {
 ...
 public String getHouseNo(){
    ...
    @Override
     public double calculateRent() {
        ...
        double monthly = getBaserent()+ 5000;
